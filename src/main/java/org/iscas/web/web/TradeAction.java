...
public class TradeAction implements TradeServices {
    ...
    // - broker mode is the only thing that really uses this
    ...
    private void createTrade() {
        ...
        if (TradeConfig.runTimeMode == TradeConfig.EJB3) {
            try {
                Class c = Class.forName("org.apache.geronimo.daytrader.javaee6.web.broker.TradeSLSBBean");
                if ((trade == null) ||
            ...
            try {
                Class c = Class.forName("org.apache.geronimo.daytrader.javaee6.web.broker.DirectSLSBBean");
                if ((trade == null) ||
                    (!(trade.getClass().isAssignableFrom(c)))) {
                    InitialContext context = new InitialContext();
                    try {
