...
import org.apache.geronimo.daytrader.javaee6.entities.AccountProfile;
...
public interface TradeServices extends Remote {
   ...
   /**
     ...
     * @return Order providing the status of the newly created buy order
     */


    public Order buy(String userID, String symbol, double quantity, int orderProcessingMode) throws Exception, RemoteException;
   ...
   /**
     ...
     * @return Order providing the status of the newly created sell order
     */
    public Order sell(String userID, Integer holdingID, int orderProcessingMode) throws Exception, RemoteException;
   ...
   /**
     ...
     * @return Order providing the status of the completed order
     */
   ...
   /**
     ...
     * @return Order providing the status of the completed order
     */
    public Order completeOrder(Integer orderID, boolean twoPhase) throws Exception, RemoteException;
   ...
   /**
     ...
     * @return Collection Orders providing detailed order information
     */
   ...
   /**
     * Return a {@link Collection} of {@link Quote}
   ...
   /**
     ...
     * @return the Quote describing the stock
     */
   ...
   /**
     ...
     * @return a Holding describing the holding
     */
    public Holding getHolding(Integer holdingID) throws Exception, RemoteException;

    /**
     * Return an Account object for userID describing the account
     *
     * @param userID the account userID to lookup
     * @return User account data in Account
     */    
   public Account getAccountData(String userID) 
           throws Exception, RemoteException;                              

    /**
     * Return an AccountProfile for userID providing the users profile
     *
     * @param userID the account userID to lookup
     * @param User account profile data in AccountProfile
     */
   public AccountProfile getAccountProfileData(String userID) throws Exception, RemoteException;                              

    /**
     * Update userID's account profile information using the provided AccountProfile object
     *
     * @param userID the account userID to lookup
     * @param User account profile data in AccountProfile
     */
   ...
   public void logout(String userID) throws Exception, RemoteException; 
     ...
     */
    public Account register(String userID,
                                    String password,
                                    String fullname,
                                    String address,
                                    String email,
