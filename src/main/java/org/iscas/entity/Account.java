...
@NamedQueries( {
        ...
        @NamedQuery(name = "account.findByOpenbalance", query = "SELECT a FROM account a WHERE a.openBalance = :openbalance"),
        @NamedQuery(name = "account.findByLogoutcount", query = "SELECT a FROM account a WHERE a.logoutCount = :logoutcount"),
        @NamedQuery(name = "account.findByBalance", query = "SELECT a FROM account a WHERE a.balance = :balance"),
        @NamedQuery(name = "account.findByAccountid", query = "SELECT a FROM account a WHERE a.accountID = :accountid"),
        @NamedQuery(name = "account.findByAccountid_eager", query = "SELECT a FROM account a LEFT JOIN FETCH a.profile WHERE a.accountID = :accountid"),
        @NamedQuery(name = "account.findByAccountid_eagerholdings", query = "SELECT a FROM account a LEFT JOIN FETCH a.holdings WHERE a.accountID = :accountid"),
        @NamedQuery(name = "account.findByLastlogin", query = "SELECT a FROM account a WHERE a.lastLogin = :lastlogin"),
        @NamedQuery(name = "account.findByLogincount", query = "SELECT a FROM account a WHERE a.loginCount = :logincount")
    })
public class Account implements Serializable {
    ...
    public static Account getRandomInstance() {
        return new Account(new Integer(TradeConfig.rndInt(100000)), //accountID
                TradeConfig.rndInt(10000), //loginCount
                TradeConfig.rndInt(10000), //logoutCount
                new Date(), //lastLogin
                new Date(TradeConfig.rndInt(Integer.MAX_VALUE)), //creationDate
